...
% Note: hyperref is loaded by cornell.cls, avoid loading again with conflicting options
%\usepackage[pdfmark, 
%breaklinks=true, 
%colorlinks=true,
%citecolor=blue,
...
\include{itBugzilla}
\include{itOverleaf}
\include{itDomainSSLSetup}
\include{itGithub}
\include{itPrometheusGrafana}
\include{itGitHubAction}
\include{itJenkinsWithPytest}
\include{itLoadBalancer}
\include{itProject}
\include{itProjectDemo}
\include{itArchitecture}
\appendix
\include{itAppendix}
